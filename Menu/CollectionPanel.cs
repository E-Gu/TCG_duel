    ...
    public class CollectionPanel : UIPanel
    {
        ...
        public void RefreshCards()
        {
            ...
            if (filter_dropdown == 1) //Attack
                all_cards.Sort((CardDataQ a, CardDataQ b) => { return b.card.attackMin == a.card.attackMin ? b.card.hp.CompareTo(a.card.hp) : b.card.attackMin.CompareTo(a.card.attackMin); });
            if (filter_dropdown == 2) //hp
                all_cards.Sort((CardDataQ a, CardDataQ b) => { return b.card.hp == a.card.hp ? b.card.attackMin.CompareTo(a.card.attackMin) : b.card.hp.CompareTo(a.card.hp); });
