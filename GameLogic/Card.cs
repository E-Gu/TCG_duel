...
namespace TcgEngine
{
    ...
    public class Card
    {
        ...
        //public virtual int GetAttack() { return Mathf.Max(Random.Range(attackMin, attackMax + 1) + attack_ongoing, 0); }
        ...
        public virtual int GetAttack()
        {
            ...
            lock(randomLock)
            {
                randomAttack = sysRandom.Next(attackMin, attackMax + 1);
            }
            return Mathf.Max(randomAttack + attack_ongoing, 0);
        }
        ...
        public virtual void SetCard(CardData icard, VariantData cvariant)
        {
            ...
            attackMin = icard.attackMin;
            attackMax = icard.attackMax;
            hp = icard.hp;
            mana = icard.mana;
            SetTraits(icard);
            SetAbilities(icard);
        ...
        public static void Clone(Card source, Card dest)
        {
            ...
            dest.attackMin = source.attackMin;
            dest.attackMax = source.attackMax;
            dest.hp = source.hp;
