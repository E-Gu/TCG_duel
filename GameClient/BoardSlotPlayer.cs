...
namespace TcgEngine.Client
{
    ...
    public class BoardSlotPlayer : BSlot
    {
        ...
        {
            // Если игра в дуэльном режиме, ничего не делаем
        ...
        {
            int playerID = GetPlayerID(); // Получаем ID игрока
            int p = Slot.GetP(playerID); // Получаем сторону (0 или 1)

            // Определяем слот для игрока
            int x = 1; // Фиксированное значение x
            int y = 1; // Фиксированное значение y
